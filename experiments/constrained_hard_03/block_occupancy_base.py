"""Block-occupancy warm base B(b, w) on the fixed-composition slice.

Promoted into the tracked tree 2026-08-23 from the warm-base review probe
of 2026-08-20 (verbatim; the probe's self-test passed 25/25 base checks).
Used by plot_base_marginals.py for the hard chapter's base-vs-target figure;
NOT wired into any training target -- the arm was never run (see the hard
chapter's base section for why).
"""
