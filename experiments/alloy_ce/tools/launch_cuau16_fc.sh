#!/bin/zsh
# 16-site Cu-Au F(c) at 500 K (s123, 2026-09-04), Modal tag 20260904-cuau16-fc:
# house c=0.5 recipe at n_Au = 4, 5, 6, 7 of 16, three seeds each; c50 landed s118.
...
# s123: same-tag composition-amortised twin (one checkpoint, five slices) and free cells
# at MetaDNS's 1200 / 680 K; the 500 K free house cell landed s119. One pull collects the set.
