...
FMO2_ARM_DECLARATIONS = {
    ...
    # The cold-CV arm — estimator the only change.
...
def test_loss_microbatch_schedule_is_confined_to_the_measured_oom_arms():
    ...
    expected = {
        ...
        "H2_d256_c50_s223_letf_thp_70k_curr_b512_ne128_cv2": 128,
        "H2_d256_c50_s223_letf_thp_70k_curr_b512_ne128_cv2_ef": 128,
        "H2_d256_c50_s223_letf_thp2_70k_curr_b512_ne128_cv2": 128,
...
# recipe deliberately has no microbatch (see its comment in configs.py).
RECIPE_DECLARATIONS = {
